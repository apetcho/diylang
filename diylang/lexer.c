...
typedef enum {
    EOI, MULTIPLY, DIVIDE, MODULO, ADD, SUBSTRACT, NEGATE, NOT, LESS,
    LESSEQUAL, GREATER, GREATEREQUAL, NOTEQUAL, ASSIGN, AND, OR, IF,
    ELSE, WHILE, PRINT, PUTC, LPAREN, RPAREN, LBRACE, RBRACE, SEMICOLON,
    COMMA, IDENTIFIER, INTEGER, STRING
} TokenEnum_t;
